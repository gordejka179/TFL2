...
"acccc" и "ecccccS", где первый символ строки S отличен от "c". Объяснение: заметим, что 2 и более буквы "c" подряд могут идти в следующих ситуациях: 
- `dcdc*c(d*|e*e)`.  
...
Но тут получится максимум подстрока "accc", а мы говорим про "acccc".
